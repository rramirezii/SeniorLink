      ...
      <ul class="nav-buttons">
        <li @click="toggle('create')" class="dropdown" :class="{ active: activeDropdown === 'create' }">
          ...
          <ul v-if="activeDropdown === 'create'" class="dropdown-content">
            <li class="dropdown-buttons"><router-link to="/create-town">Town</router-link></li>
            <li class="dropdown-buttons"><router-link to="/create-establish">Establishment</router-link></li>
            <li class="dropdown-buttons"><router-link to="/create-super">Super Admin</router-link></li>
            </ul>
        </li>
        <li @click="toggle('view')" class="dropdown" :class="{ active: activeDropdown === 'view' }">
          View Account
          <ul v-if="activeDropdown === 'view'" class="dropdown-content">
            <li class="dropdown-buttons"><router-link to="/view-town">Towns</router-link></li>
            ...
            <li class="dropdown-buttons"><router-link to="/view-super">Super Admin</router-link></li>
            <li class="dropdown-buttons"><router-link to="/view-establish">Establishment</router-link></li>
            </ul>
        </li>
...
.dropdown-content {
  ...
  align-items: center;
  margin-top: 5%;
  text-align: center;  /* Center align text within each dropdown button */
  padding-left: 10%;
}
