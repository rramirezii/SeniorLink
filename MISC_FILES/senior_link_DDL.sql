...
--
-- Host: localhost    Database: senior_link
-- ------------------------------------------------------
...
CREATE TABLE `barangay` (
  ...
  PRIMARY KEY (`id`),
  KEY `town_id` (`town_id`),
  CONSTRAINT `barangay_ibfk_1` FOREIGN KEY (`town_id`) REFERENCES `town` (`id`)
...
CREATE TABLE `product_transaction` (
  ...
  CONSTRAINT `product_transaction_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`),
  CONSTRAINT `product_transaction_ibfk_2` FOREIGN KEY (`transaction_id`) REFERENCES `transaction` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `senior` (
  ...
  CONSTRAINT `senior_ibfk_1` FOREIGN KEY (`barangay_id`) REFERENCES `barangay` (`id`),
  CONSTRAINT `senior_chk_1` CHECK (regexp_like(`cellphone_number`,_utf8mb4'[0-9]+$'))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sessions` VALUES ('kkCr0NLFYisCnv1w9VtSNKtlaap9QOPUwTA8BIsQ',NULL,'127.0.0.1','Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:124.0) Gecko/20100101 Firefox/124.0','YTozOntzOjY6Il90b2tlbiI7czo0MDoic3ZUZ3d6WmJzS3llbEFYUVN2ZUdSS0Q0ZFc2SEVtVDZxOFY4WlRXRyI7czo5OiJfcHJldmlvdXMiO2E6MTp7czozOiJ1cmwiO3M6MjE6Imh0dHA6Ly8xMjcuMC4wLjE6ODAwMCI7fXM6NjoiX2ZsYXNoIjthOjI6e3M6Mzoib2xkIjthOjA6e31zOjM6Im5ldyI7YTowOnt9fX0=',1713367412);
...
CREATE TABLE `transaction` (
  ...
  CONSTRAINT `transaction_ibfk_1` FOREIGN KEY (`senior_id`) REFERENCES `senior` (`id`),
  CONSTRAINT `transaction_ibfk_2` FOREIGN KEY (`establishment_id`) REFERENCES `establishment` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
